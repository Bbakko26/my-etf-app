...
try:
        ...
        if not detail_df.empty:
            ...
            if code != "CASH":
                try:
                    ...
                    st.plotly_chart(fig, use_container_width=True, key="detail_candle")
    ...
    with tabs[1]:
        ...
        st.plotly_chart(px.pie(grp_df, values='평가금액', names='자산군', hole=0.4), use_container_width=True, key="main_pie")
